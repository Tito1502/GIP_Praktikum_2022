...
int main()
{
    ...
    unsigned int x1 = random_unsigned(0, size_x / 2 - 2);
    unsigned int y1 = random_unsigned(0, size_y / 2 - 2);
    unsigned int x2 = random_unsigned(x1 + 4, size_x - 1);
    unsigned int y2 = random_unsigned(y1 + 4, size_y - 1);
